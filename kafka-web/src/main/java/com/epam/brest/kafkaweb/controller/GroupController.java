...
*/
  ...
  /*      this.mapper = mapper;*/
    ...
    public final String groups (Model model) throws InterruptedException {
        ...
        while (groupConsumerService.isListChanged == false){Thread.sleep(1000);}
        ...
        groupConsumerService.isListChanged = false;
    ...
    public String create(@ModelAttribute("group") @Valid Group group,
                         BindingResult result, Model model) throws SQLException, JsonProcessingException, InterruptedException {
